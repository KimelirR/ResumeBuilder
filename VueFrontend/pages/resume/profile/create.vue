                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-2">
                                                ...
                                                <input v-model="newProfile.linkedin_url" type="text" id="linkedin_url"
                                                    class="form-control border-primary" placeholder="linkedIn Url"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-2">
                                                ...
                                                <input v-model="newProfile.github_url" type="text" id="github_url"
                                                    class="form-control border-primary" placeholder="Github url link"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-2">
                                                ...
                                                <input v-model="newProfile.personal_website" type="text"
                                                    ...
                                                    placeholder="Personal Website Url" name="personal_website" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-2">
                                                ...
                                                <input v-model="newProfile.user_summary" type="text" id="user_summary"
                                                    class="form-control border-primary" placeholder="Job summary"
                                                    name="user_summary" required>
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-text"><button
                                                            ...
                                                            @click="addSkill"><i class="bi bi-plus"></i></button></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-text"><button
                                                            class="btn btn-sm btn-success" type="button"
                                                            @click="addHobby"><i class="bi bi-plus"></i></button></span>
                                                </div>
                                            </div>
