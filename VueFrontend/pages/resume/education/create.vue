<template>
    <PartialsHeader title="Education Section">
        ...
        <div class="card">
            <div class="card-body">
                <form @submit.prevent="createEducation" class="form form-horizontal needs-validation" novalidate>
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group mb-2">
                                    ...
                                    <input v-model="newEducation.course_title" type="text" id="course_title"
                                        class="form-control " placeholder="Course Title" name="course_title" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-2">
                                    ...
                                    <input v-model="newEducation.final_grade" type="text" id="final_grade"
                                        class="form-control border-primary" placeholder="Final Grade" name="final_grade"
                                        required>
