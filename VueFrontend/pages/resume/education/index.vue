        ...
        <div v-for="(education, index) in educations" :key="index" class="card mt-2">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    ...
                    <form @submit.prevent="submitEducationForm(index)" class="form form-horizontal needs-validation"
                        novalidate>
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <label class="label-control" for="course_title">Course
                                            Title</label>
                                        <input v-model="education.course_title" type="text" id="course_title"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <label class="label-control" for="card_title">Card
                                            Title</label>
                                        <select v-model="education.card_title" class="form-select border-primary"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <label class="label-control" for="school_name">School
                                            Name</label>
                                        <input v-model="education.school_name" type="text" id="school_name"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <label class="label-control" for="education_level">Education
                                            Level</label>
                                        <input v-model="education.education_level" type="text" id="education_level"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <label class="label-control" for="final_grade">Final
                                            Grade</label>
                                        <input v-model="education.final_grade" type="text" id="final_grade"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <label class="label-control" for="start_date">Start
                                            Date</label>
                                        <input v-model="education.start_date" type="date" id="start_date"
