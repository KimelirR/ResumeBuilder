<template>
    <PartialsHeader title="Project Section">
        <div class="card mb-2">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-2">
                                                <label class="label-control" for="project_name">Project
                                                    Name</label>
                                                <input v-model="newProject.project_name" type="text" id="project_name"
                                                    class="form-control border-primary" placeholder="Project Name"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-2">
                                                ...
                                                <input v-model="newProject.project_url" type="text" id="project_url"
                                                    class="form-control border-primary" placeholder="Project url link"
