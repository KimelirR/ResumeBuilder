        ...
        <div v-for="(experience, index) in experiences" :key="index" class="card mt-2">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    ...
                    <form @submit.prevent="submitExperienceForm(index)" class="form form-horizontal needs-validation"
                        novalidate>
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <label class="label-control" for="card_title">Card
                                            Title</label>
                                        <select v-model="experience.card_title" class="form-select border-primary"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <label class="label-control" for="company_name">Company
                                            Name</label>
                                        <input v-model="experience.company_name" type="text" id="company_name"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <label class="label-control" for="company_url">Company
                                            Url</label>
                                        <input v-model="experience.company_url" type="text" id="company_url"
                                            class="form-control border-primary" placeholder="Company Url"
                                            name="company_url" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-2">
                                        <label class="label-control" for="start_date">Start
                                            Date</label>
                                        <input v-model="experience.start_date" type="date" id="start_date"
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-text"><button class="btn btn-sm btn-success"
                                                    type="button" @click="addDescription(index)"><i
                                ...
                                <div class="row">
                                    <div class="form-actions my-2">
                                        ...
                                        <button @click="deleteExperience(experience.experience_id)"
                                            class="btn btn-sm btn-danger float-end mx-2"><i class="bi bi-trash3"></i>
                                            {{ ' ' }}Delete
                                        </button>
                                    </div>
                                </div>
